...
report(
  "CMAC-AES-256 8K",
  benchmark(() => new CMAC(aes).update(buf8192).digest(), buf8192.length)
);
report(
  "CMAC-AES-256 1K",
  benchmark(() => new CMAC(aes).update(buf1024).digest(), buf1024.length)
);
report(
  "CMAC-AES-256 32",
  benchmark(() => new CMAC(aes).update(buf32).digest(), buf32.length)
);
